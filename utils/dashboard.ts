import type { DashboardPaymentBreakdown, DashboardSalesSummary, DashboardStatusCounts, DashboardTopProduct, DashboardTrendBucket, DashboardTrendPoint } from '@/types/sales';
